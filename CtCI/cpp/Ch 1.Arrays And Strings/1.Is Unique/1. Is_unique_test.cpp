...
TEST(CH1_IS_UNIQUE, TRIVIAL_TRUE) { EXPECT_TRUE(isUniqueChars("a")); }

TEST(CH1_IS_UNIQUE, TRIVIAL_FALSE) { EXPECT_FALSE(isUniqueChars("aa")); }

TEST(CH1_IS_UNIQUE, NOT_CASE_SENSITIVE) { EXPECT_FALSE(isUniqueChars("aA")); }
...
TEST(CH1_IS_UNIQUE_noDS, TRIVIAL_TRUE) { EXPECT_TRUE(isUniqueChars_noDS("a")); }
